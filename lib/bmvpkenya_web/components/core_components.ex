defmodule BmvpkenyaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BmvpkenyaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BmvpkenyaWeb.Gettext, "errors", msg, opts)
    end
  end
